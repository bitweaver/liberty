...
// +----------------------------------------------------------------------+
// $Id: data.spytext.php,v 1.13 2007/06/09 18:09:39 squareing Exp $

/******************
 * Initialization *
 ******************/
global $gLibertySystem;
define( 'PLUGIN_GUID_DATASPYTEXT', 'dataspytext' );
$pluginParams = array (
	'tag' => 'SPYTEXT',
	'auto_activate' => FALSE,
	'requires_pair' => TRUE,
...
$gLibertySystem->registerDataTag( $pluginParams['tag'], PLUGIN_GUID_DATASPYTEXT );
			...
			.'<table width="100%" border="0" cellspacing="0" cellpadding="0">'
				.'<tr>'
					...
					.'<td style="text-align:center">'
						.'<a title="Expand/Contract for Addresses" href="javascript:flip(' .$spyId. ')">Address</a>'
					.'</td>'
					.'<td width=42%><hr></td>'
				.'</tr>'
			.'</table>'
			...
			$spyLink = '<div>'
				.'<table width="100%" border="0" cellspacing="0" cellpadding="0">'
					.'<tr>'
						...
						.'<td style="text-align:center">'
							.'<a title="Expand/Contract for Hidden Text" href="javascript:flip('.$spyId.')">'.$title.'</a>'
						.'</td>'
						.'<td width='.$width.'><hr></td>'
					.'</tr>'
				.'</table>'
