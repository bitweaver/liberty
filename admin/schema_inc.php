...
$gBitInstaller->registerUserPermissions( LIBERTY_PKG_NAME, array(
	...
	array('bit_p_remove_own_comments', 'Can delete own comments', 'registered', LIBERTY_PKG_NAME),
	...
	array('bit_p_edit_own_comments', 'Can edit own comments', 'registered', LIBERTY_PKG_NAME),
