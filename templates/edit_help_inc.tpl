{* $Header: /cvsroot/bitweaver/_bit_liberty/templates/edit_help_inc.tpl,v 1.22 2006/11/16 16:47:00 squareing Exp $ *}
		...
		{if $dataplugins|count ne 0}
			...
			{foreach from=$dataplugins item=p}
				<script type="text/javascript">/*<![CDATA[*/
					document.write( '<div id="{$p.plugin_guid}1" style="display:none;">' );
				/*]]>*/</script>
