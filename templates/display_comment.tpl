...
{/if}
	<div class="post" id="comment_{$comment.content_id}">
		<div class="floaticon">
			...
			{/if}
			{if $gBitUser->hasPermission('p_liberty_admin_comments') || ($gBitUser && $comment.user_id == $gBitUser->mInfo.user_id && $comment.user_id!=$smarty.const.ANONYMOUS_USER_ID) || $comment.editable}
